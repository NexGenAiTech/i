    ...
    <style>
        * {
        ...
        .chat-window {
            ...
            flex-direction: column;
            overflow: hidden;
            height: 100%; /* Added to fit container */
        }
        ...
        .message {
            max-width: 80%;
            padding: 10.8px 14.4px; /* Reduced from 12px 16px */
            border-radius: 18px;
            line-height: 1.4;
        ...
        .sidebar-toggle {
            display: none;
            position: absolute;
            top: 13.5px; /* Reduced from 15px */
            left: 13.5px; /* Reduced from 15px */
            background: #6e48aa;
            color: white;
            border: none;
            width: 40px;
        ...
        @media (max-width: 480px) {
            ...
            .message {
                padding: 9px 12.6px; /* Reduced from 10px 14px */
                font-size: 0.95rem;
            }
        }
    </style>
...
<body>
    <!-- Toggle button for sidebar (visible on mobile only) -->
    ...
    <div class="sidebar" id="sidebar">
        <div class="header">
            <h1>AI Chatbot</h1>
            <p>Powered by OpenRouter and DeepSeek R1</p>
        </div>
        ...
        <div class="api-config">
            ...
            <div class="config-group">
                ...
                <input type="text" id="api-key" value="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">
            </div>
            ...
            <div class="keyboard-hint">
                <i class="fas fa-keyboard"></i> Press Enter to send message
            </div>
            
            <div class="model-info">
                <p><strong>Current Model:</strong> DeepSeek R1 0528</p>
                <p>This is a free model via OpenRouter. Responses may take a few moments.</p>
            </div>
        </div>
    </div>
        ...
        <div class="chat-window">
            <div class="chat-header">
                ...
                <div class="chat-controls">
                    <button id="clear-chat" title="Clear Chat"><i class="fas fa-broom"></i></button>
                </div>
            </div>
            ...
            <div class="chat-messages" id="chat-messages">
                <div class="message bot-message">
                    <div class="message-content">
                        <p>Hello! I'm your AI assistant powered by DeepSeek R1. How can I help you today?</p>
                    </div>
